...
class Ui_Console(object):
    def setupUi(self, Console):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.GroupBox_order.sizePolicy().hasHeightForWidth())
        self.GroupBox_order.setSizePolicy(sizePolicy)
        self.GroupBox_order.setMinimumSize(QtCore.QSize(300, 110))
        self.GroupBox_order.setMaximumSize(QtCore.QSize(16777215, 120))
        ...
        self.Button_limit_long = QtWidgets.QPushButton(self.horizontalLayoutWidget_7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Button_limit_long.sizePolicy().hasHeightForWidth())
        self.Button_limit_long.setSizePolicy(sizePolicy)
        self.Button_limit_long.setMinimumSize(QtCore.QSize(80, 0))
        self.Button_limit_long.setMaximumSize(QtCore.QSize(90, 16777215))
        self.Button_limit_long.setObjectName("Button_limit_long")
        self.horizontalLayout_longshort.addWidget(self.Button_limit_long)
        self.Button_limit_short = QtWidgets.QPushButton(self.horizontalLayoutWidget_7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Button_limit_short.sizePolicy().hasHeightForWidth())
        self.Button_limit_short.setSizePolicy(sizePolicy)
        self.Button_limit_short.setMinimumSize(QtCore.QSize(80, 0))
        self.Button_limit_short.setMaximumSize(QtCore.QSize(90, 16777215))
        self.Button_limit_short.setObjectName("Button_limit_short")
        self.horizontalLayout_longshort.addWidget(self.Button_limit_short)
        self.gridLayout_limit_order.addLayout(self.horizontalLayout_longshort, 2, 0, 1, 1)
        ...
        self.Edit_limit_price.setInputMethodHints(QtCore.Qt.ImhDigitsOnly)
        self.Edit_limit_price.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        ...
        self.horizontalLayout_limit_price.addWidget(self.label)
        self.Edit_qty = QtWidgets.QLineEdit(self.horizontalLayoutWidget_7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Edit_qty.sizePolicy().hasHeightForWidth())
        self.Edit_qty.setSizePolicy(sizePolicy)
        self.Edit_qty.setMinimumSize(QtCore.QSize(50, 20))
        self.Edit_qty.setMaximumSize(QtCore.QSize(50, 20))
        self.Edit_qty.setInputMethodHints(QtCore.Qt.ImhDigitsOnly)
        self.Edit_qty.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.Edit_qty.setObjectName("Edit_qty")
        self.horizontalLayout_limit_price.addWidget(self.Edit_qty)
        self.gridLayout_limit_order.addLayout(self.horizontalLayout_limit_price, 1, 0, 1, 1)
        self.horizontalLayout_order.addLayout(self.gridLayout_limit_order)
        spacerItem2 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.horizontalLayout_order.addItem(spacerItem2)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Button_market_long.sizePolicy().hasHeightForWidth())
        self.Button_market_long.setSizePolicy(sizePolicy)
        self.Button_market_long.setMinimumSize(QtCore.QSize(80, 0))
        self.Button_market_long.setMaximumSize(QtCore.QSize(90, 16777215))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Button_market_short.sizePolicy().hasHeightForWidth())
        self.Button_market_short.setSizePolicy(sizePolicy)
        self.Button_market_short.setMinimumSize(QtCore.QSize(80, 0))
        self.Button_market_short.setMaximumSize(QtCore.QSize(90, 16777215))
        ...
        self.verticalLayout_6.addWidget(self.GroupBox_order)
        ...
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.tab_ticker)
        ...
        self.horizontalLayout_4.addWidget(self.TableWidget_tickers)
        self.TabWidget_data.addTab(self.tab_ticker, "")
        self.tab_price = QtWidgets.QWidget()
        self.tab_price.setObjectName("tab_price")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.tab_price)
        ...
        self.horizontalLayout_5.addWidget(self.TableWidget_prices)
        ...
        spacerItem3 = QtWidgets.QSpacerItem(308, 108, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, Console):
        ...
        self.Button_limit_long.setText(_translate("Console", "Long"))
        self.Button_limit_short.setText(_translate("Console", "Short"))
        self.Edit_limit_price.setPlaceholderText(_translate("Console", "price"))
        self.label.setText(_translate("Console", "@"))
        self.Edit_qty.setPlaceholderText(_translate("Console", "qty"))
