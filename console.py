...
class Ui_Console(object):
    def setupUi(self, Console):
        ...
        self.prices_tableWidget.setGeometry(QtCore.QRect(30, 60, 231, 321))
        self.prices_tableWidget.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.prices_tableWidget.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.prices_tableWidget.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.prices_tableWidget.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.prices_tableWidget.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.prices_tableWidget.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.prices_tableWidget.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.prices_tableWidget.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.prices_tableWidget.setGridStyle(QtCore.Qt.DashLine)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.prices_tableWidget.setItem(0, 0, item)
        item = QtWidgets.QTableWidgetItem()
        brush = QtGui.QBrush(QtGui.QColor(0, 255, 127))
        brush.setStyle(QtCore.Qt.NoBrush)
        item.setBackground(brush)
        self.prices_tableWidget.setItem(1, 0, item)
        item = QtWidgets.QTableWidgetItem()
        brush = QtGui.QBrush(QtGui.QColor(0, 255, 127))
        brush.setStyle(QtCore.Qt.NoBrush)
        item.setBackground(brush)
        self.prices_tableWidget.setItem(2, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.prices_tableWidget.setItem(3, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.prices_tableWidget.setItem(4, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.prices_tableWidget.setItem(5, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.prices_tableWidget.setItem(6, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.prices_tableWidget.setItem(7, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.prices_tableWidget.setItem(8, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.prices_tableWidget.setItem(9, 0, item)
    ...
    def retranslateUi(self, Console):
        ...
        item.setText(_translate("Console", "Qty"))
        __sortingEnabled = self.prices_tableWidget.isSortingEnabled()
        self.prices_tableWidget.setSortingEnabled(False)
        self.prices_tableWidget.setSortingEnabled(__sortingEnabled)
